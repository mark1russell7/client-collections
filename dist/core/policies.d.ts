 ...
 */
export type OverflowPolicy = "throw" | "drop-oldest" | "drop-newest" | "reject" | "grow" | "block";
/**
 ...
 */
export type UnderflowPolicy = "throw" | "return-none" | "return-default" | "block";
/**
 ...
 */
export type EvictionPolicy = "lru" | "lfu" | "fifo" | "lifo" | "random" | "ttl" | "priority" | "custom";
/**
 ...
 */
export type EvictionSelector<T> = (candidates: EvictionCandidate<T>[]) => T | undefined;
/**
 ...
 */
export type ConflictResolutionPolicy = "last-write-wins" | "first-write-wins" | "merge" | "throw";
/**
 ...
 */
export declare const DEFAULT_OVERFLOW_POLICY: OverflowPolicy;
/**
 * Default underflow policy: throw an error.
 */
export declare const DEFAULT_UNDERFLOW_POLICY: UnderflowPolicy;
/**
 ...
 */
export declare const DEFAULT_CONFLICT_POLICY: ConflictResolutionPolicy;
/**
 * Default growth policy: double capacity.
 */
export declare const DEFAULT_GROWTH_POLICY: GrowthPolicy;
/**
