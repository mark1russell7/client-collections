 ...
 */
export interface ReadonlyCollectionBase<T> extends Sized, Emptiable, Iterable<T>, ArrayConvertible<T> {
}
/**
 * Base mutable collection capabilities.
 * Adds mutation operations to readonly base.
 */
export interface MutableCollectionBase<T> extends ReadonlyCollectionBase<T>, Clearable {
}
/**
